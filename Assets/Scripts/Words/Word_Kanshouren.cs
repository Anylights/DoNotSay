...
public class Word_kanshouren : MonoBehaviour
{
    [Header("NPC Type Settings")]
    public NPCManager npc;
    public string NextDialoguePart;

    public Word_Fengzi Fengzi;
    public DialogueLine Fengzi_dialogueLine;
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        if (other.CompareTag("Word") && !dialogueEnded)
        {
            ...
            Fengzi.isWordTrue = true;
            Fengzi_dialogueLine.dialogueText = "<color=red><shake>那能否决一切的神，还在沉睡!</>";
        }
    }
}
