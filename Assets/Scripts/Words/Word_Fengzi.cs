...
public class Word_Fengzi : MonoBehaviour
{
    ...
    {
        if (other.CompareTag("Word") && !dialogueEnded && isWordTrue)
        {
            ...
            EventCenter.Instance.TriggerEvent("FengziWordTriggered");
        }
    }
}
